...
void Heading::transformation(float uncalibrated_values[3], float* calibrated_values)    
{
...
Heading::Heading(TwoWire *dev_i2c){
...
float Heading::getAverage(float last){
